...
import org.hawk.measure.impl.NumberOfClassesInComponent;
...
public class NumberOfClassesInComponentTest {
	...
	@Test
	public void testNumberOfClassesInComponent() throws Exception {
		System.out.println("\n\n testNumberOfClassesInComponent *****");
		NumberOfClassesInComponent measure = new NumberOfClassesInComponent();
