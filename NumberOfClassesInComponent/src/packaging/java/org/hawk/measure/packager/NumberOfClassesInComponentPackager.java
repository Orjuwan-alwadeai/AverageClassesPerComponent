...
public class NumberOfClassesInComponentPackager {
	public static final String JAR_RELATIVE_LOCATION = "/target/NumberOfClassesInComponent-0.0.1.jar";
	public static final String ZIP_NAME = "/NumberOfClassesInComponent.zip";

	public static void main(String[] args) {
		HawkQuerySMMMMeasure measure = new HawkQuerySMMMMeasure("NumberOfClassesInComponent", "number of classes in a component");
		measure.removeScopeProperty(HawkQueryConstants.QUERY);
		measure.removeScopeProperty(HawkQueryConstants.QUERY_LANGUAGE);

		measure.addScopeProperty("componentName", " ", "");
